...
curl -X POST -H "Content-Type: application/json" -d '{"name":"Event One","longitude":19.04,"latitude":47.50,"startTime":"2025-06-04T10:00:00Z","endTime":"2025-06-04T12:00:00Z"}' $API_URL
