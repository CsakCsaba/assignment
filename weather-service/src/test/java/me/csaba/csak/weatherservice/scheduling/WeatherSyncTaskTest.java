...
class WeatherSyncTaskTest {
    ...
    void setUp() {
        ...
        this.weatherSyncTask = new WeatherSyncTask(this.weatherService, this.eventRepository);
    }
    ...
    //
    //    final LocationProperties prop2 = new LocationProperties();
    //    prop1.setTimestamp(event.getStartTime().minusSeconds(200));
    //    prop1.setTemperature(26.0);
    //    prop1.setWindSpeed(8.0);
    //
    //    when(this.weatherService.getWeather(10.0, 20.0)).thenReturn(List.of(prop1, prop2));
    //
    //    this.weatherSyncTask.run();
